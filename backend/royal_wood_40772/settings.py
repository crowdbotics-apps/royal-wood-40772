"""
Django settings for royal_wood_40772 project.
...
ROOT_URLCONF = 'royal_wood_40772.urls'
...
WSGI_APPLICATION = 'royal_wood_40772.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_wood_40772 API",
    "DESCRIPTION": "API documentation for royal_wood_40772 App",
    "VERSION": "v1",
}
